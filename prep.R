...
## define the numbers of regions from the user
# nregions = 2
# nregions = 3
# nregions = 4
...
optimise_table = data.frame(option = 1,
                            "zone 1" = res$intervention[res$zone == 1],
                            "zone 2" = res$intervention[res$zone == 2],
                            "zone 3" = res$intervention[res$zone == 3],
